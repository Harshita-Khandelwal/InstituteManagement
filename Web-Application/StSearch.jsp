...
%>
<center><h1>View/Edit Student Profile</h1></center>

<form method="get" action="StView.jsp">
<h2>Search By <%= s %></h2>
<table>
...
<td><a href="StView.jsp?hidden=<%=s%>&cid=<%=cid%>&bid=<%=Db.rs.getInt("batch_id")%>">Show Student Details</a></td>
</tr>
<%				
				}
				i++;
