...
%>
<center><h1>View/Edit Fee Details</h1></center>

<form method="get" action="FeeView.jsp">
<h2>Search By <%= s %></h2>
<table>
...
<td><a href="FeeView.jsp?hidden=<%=s%>&cid=<%=cid%>&bid=<%=Db.rs.getInt("batch_id")%>">Show Fee Details</a></td>
</tr>
<%				
				}
				i++;
